...
이 저장소 루트에 있는 **주요 디렉터리**를 한눈에 이해할 수 있도록, 아래에 **친절한 안내서**를 모아 두었습니다. 처음이셔도 순서대로 읽으면 큰 그림이 잡힙니다.
...
| [test.md](./test.md) | `test/` | **단위 테스트** — 패키지·인프라·참조 구현 검증 |

운영·SLO·보안 요약은 루트의 **[`PLAYBOOK.md`](../PLAYBOOK.md)** 를 함께 보시면 좋습니다.
