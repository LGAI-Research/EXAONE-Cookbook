"""RAG context formatting via ToolAgent (rag) rag.retrieve tool."""
...
class TestRagRetrieveContextFormatting(unittest.TestCase):
    def test_retrieve_uses_chunk_markers(self):
        ...
        self.assertIn('<chunk index="1">', content)
        self.assertIn("Fact A.", content)
